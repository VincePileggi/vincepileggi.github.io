...
![](images/VincePileggi.png){fig-alt="Portrait photograph" width="80%"}

:::

::: {.column width="70%"}

I am a wastewater engineering specialist, applied statistician, and educator with expertise in environmental data analytics, technology assessment, and evidence-based decision-making.
...
For comments, questions, or suggestions related to the educational material presented on this website, please visit the GitHub repository linked in the navigation bar. GitHub users may contact me by opening an issue in the relevant repository or by using the contact options available through my GitHub profile. This website is maintained in a personal capacity and is independent of my professional role.
